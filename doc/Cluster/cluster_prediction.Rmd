...
# Load EM results
```{r}
load("/Users/djparker/Documents/GitHub/Fall2017-project4-grp8/output/gamma_em_result_9.RData")
load("/Users/djparker/Documents/GitHub/Fall2017-project4-grp8/output/mu_em_result_9.RData")
```
...
# Save prediction
```{r}
write.csv(r, file = "~/Documents/GitHub/Fall2017-project4-grp8/output/predict.csv")
```